...
const subjectName = infoTable.querySelector('tr:first-child > td:nth-child(2) > strong')?.textContent?.trim();
const classCode = infoTable.querySelector('tr:nth-child(3) > td:nth-child(2) > strong')?.textContent?.trim();
