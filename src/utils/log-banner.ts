...
console.log(
    `%c 🎓 SV HaUI Helper %c 🚀 v${__APP_VERSION__} %c 🕒 ${__BUILD_TIME__} %c 👨‍💻 VuQuan %c` +
        `\n%c⚠️ [THÔNG BÁO] Tiện ích đã chuyển sang Browser Extension: https://github.com/vuquan2005/svHaUI-Helper/releases` +
    ...
    '',
    'color: #eab308; font-size: 13px; font-weight: bold; margin-top: 10px;',
    'color: #c56798; font-size: 13px; font-weight: bold; margin-top: 8px; margin-bottom: 3px;',
